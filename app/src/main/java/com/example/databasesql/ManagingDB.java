...
public class ManagingDB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gestion_base);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                builder.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    private void delete(ListView lv, int p) {
                        ...
                        dataBase.delete(i);
                        Toast.makeText(ManagingDB.this, "Suppression avec succes", Toast.LENGTH_SHORT).show();
                        viewData();
                    }
                });
                builder.show();
    ...
    private void showUpdate(Activity ac, ListView lv, int p){
        ...
        final EditText mail=(EditText)dialog.findViewById((R.id.email));
        final EditText phone=(EditText)dialog.findViewById(R.id.phone);
        Button bt=(Button)dialog.findViewById(R.id.update);
        ...
        bt.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ManagingDB.this, "Mise a jour avec sucees", Toast.LENGTH_SHORT).show();
